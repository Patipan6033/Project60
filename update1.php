...
<title>UPDATE</title>
<link href="search_update1.css" rel="stylesheet" type="text/css"/>
...
<div id="form-m">
    <div id="form-d">
    <p id = "p1">แก้ไขข้อมูล</p>
    <form class="form" name = "Form" action="update2.php"  require >
			<input type="text" name = "liplate" placeholder="เลขทะเบียนรถยนต์"  id = "input1"  class="in1 " style="color: black;"  required/>
            <input type="text" name = "pro" placeholder="จังหวัด" id = "input1" class="in2"  required/>
